export default function DateSidebar(props) {
    ...
    return (
        <div className="absolute top-0 left-0 px-3 w-full h-20 z-10 md:px-0 md:h-full md:w-28 flex flex-row justify-center md:flex-col">
                ...
                {dates.map((date) => {
                    return (
                        ...
                        >
                            ...
                            {props.activeDate == date ? (
                                <div className="bg-default-900 w-full h-12 absolute bottom-3 md:bottom-5 rounded-md left-0 md:rounded-l-none"></div>
                            ) : (
