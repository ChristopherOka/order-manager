...
const Popover = (props) => {
    ...
    return (
        <div className="relative">
            <div className={`${popOverState == 'open' ? 'animate-fadeIn' : popOverState == 'closed' ? 'animate-fadeOut' : 'hidden'}`}>
                <div className="bg-default-900 text-default-100 rounded-md p-4 whitespace-nowrap absolute left-1/2 -translate-x-1/2 z-50 -mt-[5.2rem]">{props.content}</div>
