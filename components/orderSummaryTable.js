            ...
            <table className="rounded-md overflow-hidden">
                ...
                <tbody>
                    {props.products.map((product, index) => {
                        return (
                            <tr key={product.product_id} className={`text-default-900 text-md print:border-t ${index % 2 == 0 ? 'bg-pink-100 print:bg-none' : ''}`}>
                                ...
                                <td className="pr-12 font-bold text-center print:text-start">
                                    ...
                                    <span className="hidden rounded-xl px-5 py-3 border-slate-400 border float-right print:inline">
                                    </span>
                                </td>
                                <td className="pr-12 font-bold text-center print:text-start">
