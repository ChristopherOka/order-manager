  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "dropdown-arrow-white": "url(/images/icons/dropdown_arrow_white.png)",
      },
      colors: {
        default: {
          100: "#fafafa",
      ...
      animation: {
        ...
        frontTileFlip: "frontTileFlip 0.25s ease-in forwards",
        backTileFlip: "backTileFlip 0.25s ease-out both",
